...
const CORE_MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        sql: include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/schema/core/v4.sql")),
    },
    Migration {
        sql: include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/schema/core/v5.sql")),
    },
    Migration {
        sql: include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/schema/core/v6.sql")),
    },
    Migration {
    ...
    Migration {
        sql: include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/schema/core/v9.sql")),
    },
    Migration {
        sql: include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/schema/core/v10.sql")),
    },
    Migration {
        sql: include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/schema/core/v11.sql")),
    },
];
